...
class AqpagoAdapter
{
    ...
    public function authorize(array $attributes)
    {
		...
		//$logger->pushHandler(new \Monolog\Handler\StreamHandler(BP . '/var/log/aqpago_attributes.log', \Monolog\Logger::DEBUG));
		...
		$aqpagoOrder->setReferenceId( $attributes['Sale']['orderId'] )
				...
				->setDescription('Pagamento realizado através do módulo de ecommerce magento 2');
