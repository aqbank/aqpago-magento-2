...
class SaleDataBuilder implements BuilderInterface
{
    ...
    public function build(array $buildSubject)
    {
        ...
        //$customer = $this->_customer->getById($address->getCustomerId());
        //$regionFactory = $objectManager->get(\Magento\Directory\Model\RegionFactory\RegionFactory::class);
        ...
        $logger->pushHandler(
            new \Monolog\Handler\StreamHandler(BP . '/var/log/aqpago_discount.log', \Monolog\Logger::DEBUG)
        );
        ...
        foreach ($quoteItems as $item) {
            ...
            } elseif ($item->getOriginalPrice() != $item->getPrice()) {
        ...
        $logger = new \Monolog\Logger('aqpago');
        $logger->pushHandler(
            new \Monolog\Handler\StreamHandler(BP . '/var/log/aqpago_saledata.log', \Monolog\Logger::DEBUG)
        );
