...
class TransactionUpdate
{
    ...
    public function beforeSetLayout(\Magento\Sales\Block\Adminhtml\Order\View $view)
    {
        ...
        $canConsult = empty($payment->getAdditionalInformation("Nsu")) && empty($payment->getAdditionalInformation("Id Refund")) && empty($payment->getAdditionalInformation("Id Cancel")) && $payment->getMethodInstance()->getCode() == 'aqpago';
